...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            #sets up the OneToOneRelationship:
            profile.user = user
...
#dont call your function 'login'
def user_login(request):
    if request.method == 'POST':
        #.get the name of the html input
        ...
        if user:
            ...
            print('Someone tried to login and failed the authentication process')
